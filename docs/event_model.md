...
This field will become useful later when additional sources such as APIs,
Kafka producers, warehouse applications, or external systems are added.
...
These remain generated local artifacts and must not be committed to Git.

After Phase 3.7, FulfillAI will contain:
...
This event layer will later support:

- SQL operational analytics
- warehouse KPIs
- inventory analytics
- fulfillment latency analysis
